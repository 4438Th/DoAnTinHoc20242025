...
public class Mode3_Product_Panel extends javax.swing.JPanel {
    ...
    public Mode3_Product_Panel(CardLayout cardLayout) {
        initComponents();
        this.cardLayout = cardLayout;
        tableModel = (DefaultTableModel) data4_Table.getModel();
    ...
    private void initComponents() {
        ...
        data4_Table = new javax.swing.JTable();
        ...
        menu_PanelLayout.setHorizontalGroup(
            ...
            .addGroup(menu_PanelLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(button_Panel, javax.swing.GroupLayout.DEFAULT_SIZE, 251, Short.MAX_VALUE)
                .addGap(0, 0, 0))
        );
        ...
        data4_Table.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        data4_Table.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        data4_Table.setAlignmentX(0.0F);
        data4_Table.setAlignmentY(0.0F);
        data4_Table.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_ALL_COLUMNS);
        data4_Table.setColumnSelectionAllowed(true);
        data4_Table.getTableHeader().setReorderingAllowed(false);
        data4_Table.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                data4_TableMouseClicked(evt);
            }
        });
        dataWrapper_ScrollPane.setViewportView(data4_Table);
        data4_Table.getColumnModel().getSelectionModel().setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        if (data4_Table.getColumnModel().getColumnCount() > 0) {
            data4_Table.getColumnModel().getColumn(0).setMaxWidth(50);
        }
    ...
    private void data4_TableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_data4_TableMouseClicked
        rowIndex = data4_Table.getSelectedRow();
    ...
    private javax.swing.JTable data4_Table;
